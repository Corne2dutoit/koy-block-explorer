...
const HYPERION_ENDPOINT = 'https://api.koy-mainnet.telos.africa/';
...
const API_ENDPOINT = 'https://api.koy-mainnet.telos.africa/';
...
export default class Koy extends BaseChain {
    getName(): string {
        return NAME;
    }
